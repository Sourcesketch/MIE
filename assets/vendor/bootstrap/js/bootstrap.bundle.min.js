            ...
            Ze(
                (function(t) {
                    ...
                    return (
                        ...
                        (a += ve(i.clientWidth, s ? s.clientWidth : 0) - o), { width: o, height: r, x: a, y: l }
                    );
                })(Le(t))
            );
    }
                    ...
                    r = ee.reduce(function(t, i) {
                        return (
                            (t[i] = (function(t, e, i) {
                                ...
                                return (
                                    (r = r || 0),
                                    (a = (a || 0) * s), [Vt, qt].indexOf(n) >= 0 ? { x: a, y: r } : { x: r, y: a }
                                );
                            })(i, e.rects, o)),
                            t
                        );
        ...
        _getPopperConfig() {
            ...
            return (
                ...
                (F.setDataAttribute(this._menu, "popper", "static"),
                    (t.modifiers = [{ name: "applyStyles", enabled: !1 }])), {...t, ...g(this._config.popperConfig, [t]) }
            );
        }
